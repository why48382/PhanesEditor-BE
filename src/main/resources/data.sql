...
VALUES ('admin@example.com', '관리자', '$2a$10$FWWMVBtbwDoYlxAdue1rV.pf8EKxbmQ.E9fj1.pQfkmfmddSzZe6m', NOW(), NOW(),
       ...
       ('user2@example.com', '유저2', '$2a$10$FWWMVBtbwDoYlxAdue1rV.pf8EKxbmQ.E9fj1.pQfkmfmddSzZe6m', NOW(), NOW(),
        'LOCAL', 'ACTIVE', true),
       ('user3@example.com', '유저3', '$2a$10$FWWMVBtbwDoYlxAdue1rV.pf8EKxbmQ.E9fj1.pQfkmfmddSzZe6m', NOW(), NOW(),
        'GOOGLE', 'ACTIVE', true),
       ('user4@example.com', '유저4', '$2a$10$FWWMVBtbwDoYlxAdue1rV.pf8EKxbmQ.E9fj1.pQfkmfmddSzZe6m', NOW(), NOW(),
        'KAKAO', 'INACTIVE', true),
       ('wnstjs031@naver.com', '유저5', '$2a$10$FWWMVBtbwDoYlxAdue1rV.pf8EKxbmQ.E9fj1.pQfkmfmddSzZe6m', NOW(), NOW(),
        'LOCAL', 'INACTIVE', true);
...
VALUES ('프로젝트 A - 웹사이트', 'http://project.a.com', '반응형 웹사이트 제작', 'JAVASCRIPT', 1, 3),
       ...
       ('프로젝트 AB - 영상 스트리밍 서비스', 'http://project.ab.com', '고화질 영상 스트리밍 플랫폼', 'PYTHON', 1, 0);
-- AB는 likes 데이터 없음


-- like
INSERT INTO `likes` (user_idx, project_idx)
VALUES (1, 1),
       (2, 1),
       (3, 1),
       (4, 2),
